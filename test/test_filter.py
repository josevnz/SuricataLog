...
class FilterTestCase(TestCase):
    ...
    def test_with_printable_payload_filter(self):
        ...
        no_payload = json.loads(
            '{"timestamp":"2022-02-08T16:32:14.900292+0000","flow_id":879564658970874,'
        ...
        payload = json.loads(
            '{"timestamp":"2022-02-08T16:32:20.491791+0000","flow_id":879564658970874,'
    ...
    def test_with_printable_payload_filter_from_file(self):
        ...
        accepted_cnt = 34
        counted = 0
        with open(BASEDIR.joinpath("eve-2.json"), encoding="utf-8") as eve_file:
            for event in eve_file:
                ...
                if "flow_id" in payload:
                    ...
                    if flow_id in self.flow_ids:
                        if "payload" in payload and payload["payload"] != "null":
    ...
    def test_nxdomain(self):
        ...
        payload = json.loads(
            '{"timestamp":"2022-02-23T19:04:05.606882+0000","flow_id":1452066252079368,'
        ...
        self.assertTrue(data_filter.accept(payload))
        payload = json.loads(
            '{"timestamp":"2022-02-08T15:08:22.266264+0000","flow_id":127219202876190,'
